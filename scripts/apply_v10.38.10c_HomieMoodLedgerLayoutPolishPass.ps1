...
Write-Host "[v10.38.10c] Applying Homie mood ledger layout polish..." -ForegroundColor Cyan
$utf8NoBom = New-Object System.Text.UTF8Encoding($false)
$cssPayload = Join-Path $payload "HOMIE_MOOD_LEDGER_LAYOUT_POLISH.css"
...
$start = "/* ===== v10.38.10c Homie Mood Ledger Layout Polish ===== */"
$end = "/* ===== v10.38.10c Homie Mood Ledger Layout Polish END ===== */"
...
if (Test-Path $version) {
  ...
  $ver = [regex]::Replace($ver, 'export const APP_VERSION = ".*?";', 'export const APP_VERSION = "10.38.10c";')
  if ($ver -notmatch 'HOMIE_MOOD_LEDGER_LAYOUT_POLISH_PASS') {
    $ver = $ver.TrimEnd() + "`r`n" + 'export const HOMIE_MOOD_LEDGER_LAYOUT_POLISH_PASS = "v10.38.10c_HomieMoodLedgerLayoutPolishPass";' + "`r`n"
  }
  [System.IO.File]::WriteAllText($version, $ver, $utf8NoBom)
}
Write-Host "[v10.38.10c] Applied. CSS/layout only." -ForegroundColor Green
Write-Host "Next:"
