...
export const PANEL_META: PanelMeta[] = [
  ...
  { id:"VegasPokerFeed", icon:"♠️", title:"Vegas Poker Feed", sub:"Tournaments + major series rail", section:"APPS", assistantName:"Poker Room Scout", assistantRole:"Vegas tournament radar", description:"Tracks Las Vegas tournament listings, major series windows, and room-by-room feed items in one panel.", quickPrompts:["What tournaments are running tonight?","Show me major series coming up.","Find lower buy-in Las Vegas events."], storageKeys:["oddengine:vegasPokerFeed:v1"], nextSteps:["Filter by room and buy-in.","Watch major series timing.","Use this panel like a poker news feed."], actions:[{ id:"calendar", label:"Open Calendar", kind:"navigate", panelId:"Calendar" }] },
  { id:"VegasPokerCashPromos", icon:"💰", title:"Vegas Poker Cash + Promos", sub:"Cash games + room promos", section:"APPS", assistantName:"Cash Game Runner", assistantRole:"Vegas cash-game and promo scout", description:"Keeps cash-game rooms, high-hand promos, splash-pot style notes, and best-room-tonight summaries in one place.", quickPrompts:["What cash rooms look best tonight?","Show me current poker promos.","Which room fits my target stakes?"], storageKeys:["oddengine:vegasPokerCashPromos:v1"], nextSteps:["Filter by room and stake.","Compare promos before you drive.","Use Best Room Tonight for a fast recommendation."], actions:[{ id:"vegas-feed", label:"Open Vegas Poker Feed", kind:"navigate", panelId:"VegasPokerFeed" }] },
