...
{ id:"CoinstoreBTCUSDTFutures", icon:"₿", title:"BTC/USDT Futures", sub:"Coinstore scalping workstation", section:"TRADING", assistantName:"Futures Copilot", assistantRole:"BTC/USDT futures setup + execution coach", description:"Dedicated Coinstore BTC/USDT futures panel with chart, signals, long/short bias, execution guardrails, and AI-style setup reads.", quickPrompts:["Show the best BTC/USDT setup right now.","Is this a long, short, or no-trade market?","What invalidates this scalping setup?"], storageKeys:["oddengine:coinstore:futures:v1","oddengine:coinstore:futures:notes:v1"], nextSteps:["Confirm regime before chasing candles.","Keep invalidation visible before entries.","Skip low-edge setups and wait for clean reclaim or breakdown."], actions:[{ id:"open-trading", label:"Open Trading", kind:"navigate", panelId:"Trading" },{ id:"open-options-terminal", label:"Open Options Sniper Terminal", kind:"navigate", panelId:"OptionsSniperTerminal" }] },
  { id:"Poker", icon:"♠️", title:"Poker", sub:"Vegas poker feed + lanes", section:"TRADING", assistantName:"Poker Scout", assistantRole:"Poker lane + series organizer", description:"Tracks Vegas series, tonight lane options, and saved room watchlist in one place.", quickPrompts:["What's worth playing tonight?","Show me value lane series.","What rooms are on my watchlist?"], storageKeys:["oddengine:vegas:prefs:v1"], nextSteps:["Pin your preferred lanes.","Review tonight lane before heading out.","Use watchlist to avoid random room picks."] },
  ...
  { id:"RenderLab", icon:"🎞️", title:"Render Lab", sub:"Legacy video + artifact pipeline", section:"CORE PANELS", assistantName:"Render Operator", assistantRole:"Render queue + artifact return guide", description:"Turns the Writers Lounge handoff into real artifacts and previews the returned files.", quickPrompts:["Run the latest legacy video handoff.","Open the finished artifact pack.","What is blocking the current render job?"], storageKeys:["oddengine:studio:handoff:v1","oddengine:renderlab:jobs:v1","oddengine:renderlab:settings:v1"], nextSteps:["Refresh the backend health before a long run.","Queue the latest handoff into the real video lane.","Open the returned release pack and verify the MP4."], actions:[{ id:"books", label:"Open Writers Lounge", kind:"navigate", panelId:"Books" }] },
  { id:"PublisherHub", icon:"🚀", title:"Publisher Hub", sub:"Release queue + publish handoff", section:"CORE PANELS", assistantName:"Publisher Ops", assistantRole:"Release checklist + publish helper", description:"Packages finished studio artifacts for listing, publishing, and catalog tracking.", quickPrompts:["Prepare this artifact for release.","What is missing before publish?","Show the latest product-ready pack."], storageKeys:["oddengine:publishHub:jobs:v1","oddengine:studio:handoff:v1"], nextSteps:["Review the release checklist before publish.","Keep product metadata and outputs together.","Use this after Render Lab finishes a real artifact."], actions:[{ id:"render", label:"Open Render Lab", kind:"navigate", panelId:"RenderLab" }] },
