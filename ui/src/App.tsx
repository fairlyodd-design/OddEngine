...
case "DevEngine": return <DevEngine onNavigate={setActive} onOpenHowTo={openHowTo} />;
  ...
  case "Poker": return <VegasPokerFeed />;
   ...
   <div className="layout" style={{ gridTemplateColumns: "1fr" }}>
    <div className="main" style={{ paddingTop: 10 }}>
     <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10, gap: 8, flexWrap: "wrap" }}>
      ...
      <button className="helpFab" onClick={() => setHelpOpen(true)} title="How to Use (F1)"> How to Use (F1)</button>
     </div>
     ...
     <FairlyGodModeHUD activePanelId={forcedPanel} onNavigate={setActive} />
  ...
  >
   ...
   <div className="main">
    ...
    {(HOWTO as any)[activeId] && (
     <button className="helpFab" onClick={() => setHelpOpen(true)} title="How to use this panel (F1)"> How to Use (F1)</button>
    )}

    {lanWarn && (
     <div className="bannerLan"> <b>LAN mode:</b> IP Lock is OFF and you are not on localhost. Dont leave this exposed.</div>
    )}
   ...
   <FairlyGodModeHUD activePanelId={activeId} onNavigate={setActive} />
