...
export const PANEL_META: PanelMeta[] = [
  ...
  { id:"Poker", icon:"♠️", title:"Poker", sub:"Tables + study + bankroll lane", section:"CORE PANELS", assistantName:"Poker Coach", assistantRole:"Session prep + bankroll helper", description:"Tracks bankroll health, session outcomes, edge tags, and study notes in one clean lane.", quickPrompts:["What does my bankroll lane say today?","Log this session and update my edge tags.","What should I study before the next table?"], storageKeys:["oddengine:poker:v1","oddengine:poker:notes:v1"], nextSteps:["Set bankroll guardrails before you sit.","Log every session the same day.","Review edge tags so leaks and strengths stay visible."] },
