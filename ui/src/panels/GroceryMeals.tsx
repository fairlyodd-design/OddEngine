      ...
      <div className="card softCard familyCohesionCard">
        <div className="familyCohesionTop">
          <div>
            ...
            <div className="familyCohesionTitle">Meals, budget, chores, and calendar should move together</div>
            <div className="small familyCohesionSub">Plan meals, protect the basket goal, turn prep into a calendar block, and keep the household board in sync.</div>
          </div>
          <div className="familyRouteRow">
            ...
            <button className="tabBtn" onClick={() => onNavigate?.("RoutineLauncher")}>Open Routines</button>
          </div>
        </div>
      </div>
