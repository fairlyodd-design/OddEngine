    ...
    <div className="page">
      ...
      {tab==="discover" && (
        <div className="card">
          ...
          <div className="card" style={{marginTop:12, background:"rgba(8,12,18,0.35)"}}>
          ...
          <div className="card">
            ...
            {filteredDeals.length === 0 ? (
              ...
              <div style={{marginTop:10}}>
                {filteredDeals.map(d => (
                  <div key={d.id} className="card" style={{background:"rgba(8,12,18,0.35)"}}>
        ...
        <>
          ...
          <div className="card">
            ...
            {filteredFavs.length === 0 ? (
              ...
              <div style={{marginTop:10}}>
                {filteredFavs.map(f => (
                  <div key={f.id} className="card" style={{background:"rgba(8,12,18,0.35)"}}>
                    <div className="row" style={{justifyContent:"space-between", alignItems:"baseline", gap:10, flexWrap:"wrap"}}>
                      <div>
        ...
        <>
          ...
          <div className="card">
            ...
            {state.notes.length === 0 ? (
              ...
              <div style={{marginTop:10}}>
                {state.notes.map(n => (
                  <div key={n.id} className="card" style={{background:"rgba(8,12,18,0.35)"}}>
