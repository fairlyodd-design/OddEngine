  ...
  return (
    <div className="page">
      ...
      <div className="card heroCard missionHero">
        ...
        <div className="h">Daily lane</div>
        ...
        {state.briefingMode && <div className="small" style={{ marginTop: 8, opacity: 0.85 }}>Briefing mode focuses the page on the mission note + key cards. Toggle it off to view full feeds.</div>}
      </div>
      ...
      <div className="grid2" style={{ alignItems: "start" }}>
        ...
        <div className="card softCard">
          ...
          <div className="small" style={{ marginTop: 10, opacity: 0.9 }}>{buildRouteNote(state)}</div>
