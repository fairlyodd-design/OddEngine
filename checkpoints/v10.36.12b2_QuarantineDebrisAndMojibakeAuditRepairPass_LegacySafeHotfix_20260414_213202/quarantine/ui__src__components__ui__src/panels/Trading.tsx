...
function ContractDrawer({
  ...
  return (
    <div id="trading_drawer" className="card optionDrawer" style={{ background: "rgba(8,12,18,0.35)", minHeight: 320 }}>
...
export default function Trading() {
  ...
  return (
    <div className="card tradingPanelRoot">
      ...
      <div className="grid2 mt-5" style={{ alignItems: "stretch" }}>
        <div id="trading_chart" className="card" style={{ background: "rgba(8,12,18,0.35)" }}>
          <div className="cluster spread">
            <div>
        ...
        <div id="trading_source" className="card" style={{ background: "rgba(8,12,18,0.35)" }}>
          <div className="cluster spread start">
            <div>
      ...
      <div id="trading_contracts" className="card mt-5" style={{ background: "rgba(8,12,18,0.35)" }}>
        <div className="cluster spread start">
          <div>
  ...
  return (
      ...
      <div className="tradingSplit mt-5">
        ...
        <div id="trading_ticket" className="card" style={{ background: "rgba(8,12,18,0.35)" }}>
          <div className="cluster spread start">
            <div>
...
<button className="tabBtn" onClick={() => setDrawerTab("detail")}>Open details</button>
        ...
        <div id="trading_plan" className="card" style={{ background: "rgba(8,12,18,0.35)" }}>
