    ...
    <div className="card">
      ...
      <div style={{ marginTop: 12, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
        <div className="card" style={{ background: "rgba(8,12,18,0.35)" }}>
          <div style={{ fontWeight: 900 }}>Tent / room profile</div>
        ...
        <div className="card" style={{ background: "rgba(8,12,18,0.35)" }}>
          ...
          <div style={{ marginTop: 10 }} className="card">
            <div className="row" style={{ justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
              <div>
                <div style={{ fontWeight: 800 }}>AC Infinity Live Import</div>
          ...
          <div style={{ marginTop: 12 }}>
            <div style={{ fontWeight: 900, marginBottom: 6 }}>Recent readings</div>
            {readings.length === 0 && <div className="small">No readings yet.</div>}
            {readings.slice(0, 6).map((r, i) => (
              <div key={i} className="row" style={{ justifyContent: "space-between", border: "1px solid var(--line)", borderRadius: 12, padding: "8px 10px", marginBottom: 6 }}>
      ...
      <div style={{ marginTop: 12, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
        <div className="card" style={{ background: "rgba(8,12,18,0.35)" }}>
          <div className="row" style={{ justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
            <div>
              <div style={{ fontWeight: 900 }}>Offline planning mode</div>
        ...
        <div className="card" style={{ background: "rgba(8,12,18,0.35)" }}>
          <div className="row" style={{ justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
            <div>
              <div style={{ fontWeight: 900 }}>Demo sensor mode</div>
