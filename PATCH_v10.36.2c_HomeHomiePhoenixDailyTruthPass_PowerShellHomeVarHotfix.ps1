...
# Home.tsx
# -------------------------
$homeText = Get-Content -Raw -LiteralPath $homePath
...
'@
$homeText = Replace-Once -Text $homeText -Find $anchorImportHome -ReplaceWith $replaceImportHome -Label "Home import"
...
'@
$homeText = Replace-Once -Text $homeText -Find $anchorTruthHome -ReplaceWith $replaceTruthHome -Label "Home daily truth"
...
'@
$homeText = Replace-Once -Text $homeText -Find $anchorUiHome -ReplaceWith $replaceUiHome -Label "Home daily truth UI"

Set-Content -LiteralPath $homePath -Value $homeText -Encoding UTF8
