...
cd /d "%~dp0"
echo ========================================
echo   Homie Voice Bridge AUDIO CLEANUP MAX
echo ========================================
echo.
echo Uses small.en + audio cleanup/normalization for better command transcription.
...
set HOMIE_AUDIO_HIGHPASS=80
set HOMIE_AUDIO_LOWPASS=7600
...
set HOMIE_WHISPER_NO_SPEECH_THRESHOLD=0.22
